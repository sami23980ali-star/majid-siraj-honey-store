...
// Fallback for browser/proxy contexts that strip or reject __Host- cookies.
// Both values are random, short-lived, and must match before exchanging OAuth code.
export const OAUTH_STATE_FALLBACK_COOKIE = "oauth_state";
